...
export const stories: Story[] = [
  ...
  },
  {
    ...
    items: [
      {
        text:
          'Mój typowy dzień stażu zawsze wygląda inaczej. O 8:30 siedzę już przy biurku.',
        gif: 'dziad.gif',
      },
      {
        text:
          'Jako testerka oprogramowania codziennie sprawdzam działanie jakiejś funkcjonalności albo uczę się pisać kod do testów.',
        gif: 'computer.gif',
      },
      {
        text:
          'Codziennie spotykam się również z moim zespołem żeby omawiać bieżące i przyszłe zadania :)',
        gif: 'teamwork.gif',
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        text:
          'Choć jest to dla mnie bardzo ciężkie, staram się wstać między 8:00, a 8:30.',
        gif: 'cat-wakeup.gif',
      },
      {
      ...
      {
        text:
          '... i jem je przy komputerze (I know, I know), sprawdzając emaile i oglądając jakieś ciekawe prelekcje.',
        gif: 'cat-pc-1.gif',
      },
      {
